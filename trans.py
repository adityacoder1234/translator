...
root.title('the Aditya Translator')
...
'bengali': 'bn', 'bosnian': 'bs', 'bulgarian': 'bg', 'catalan': 'ca', 'cebuano': 'ceb', 'chichewa': 'ny', 'chinese (simplified)': 'zh-cn', 'chinesestonian': 'et','english': 'en', 'filipino': 'tl', 'finnish': 'fi', 'french': 'fr', 'frisian': 'fy', 'galician': 'gl', 'georgian': 'ka', 'german': 'de', 'greek': 
...
entry1.bind('<Enter>',on_leaveentry1)

entry2.bind('<Enter>',on_enterentry2)
entry2.bind('<Enter>',on_leaveentry2)

btn1.bind('<Enter>',on_enterbtn1)
btn1.bind('<Enter>',on_leavebtn1)

btn2.bind('<Enter>',on_enterbtn2)
btn2.bind('<Enter>',on_leavebtn2)
